            ...
            <div className="space-y-4">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="flex items-center justify-between">
                  <div>
                    <p className="font-medium">Tech Conference {i}</p>
                    <p className="text-sm text-muted-foreground">Created 2 hours ago</p>
                  </div>
                  <span className="text-sm bg-green-100 text-green-800 px-2 py-1 rounded">Published</span>
                </div>
              ))}
            </div>
          </CardContent>
              ...
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Registered for Tech Conference</p>
                  </div>
